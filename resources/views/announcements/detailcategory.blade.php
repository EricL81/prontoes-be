    ...
    <div class="content-wrapper">
        <div class="row p-4">
            <div class='col-12 text-center'>
                <h1>{{__('ui.allAdsFrom')}} <span style="color: var(--main-colordark); text-shadow: 2px 2px 2px var(--main-light)">{{__("ui.{$category->name}")}}</span></h1>
            </div>
        </div>
                    ...
                    <div class="card my-3 mycard">
                        <div class="row">
                            <div class="col-12 col-md-4 col-xl-6 d-flex justify-content-center">
                                <img class="img-fluid h-100 p-3" style="object-fit: cover;" width="300" height="380" src="{{$announcement->images->first()->getUrl(300,380)}}"
                                     alt="...">
                            </div>
