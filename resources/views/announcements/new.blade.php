        ...
        <div class="col-12 col-md-4 offset-md-4">
            <form action="{{route('createAnnouncement')}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{old("description")}}" name="description" type="text" class="form-control" id="exampleInputdescription1">
                    <div id="nameHelp" class="form-text">
                        @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <input value="{{old("price")}}" name="price" type="number" class="form-control" id="exampleInputPrice1">
                    <div id="nameHelp" class="form-text">
                        @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
