            ...
            <div class="d-flex justify-content-center">
                <ul class="d-flex list-unstyled justify-content-center align-items-center mb-0">
                    ...
                    <li class="nav-item me-2">
                        <a class="text-decoration-none login d-flex align-items-center justify-content-center fw-bold fs-6" href='/login'>{{__('ui.login')}}</a>
                    </li>
                    <li class="nav-item me-2">
                        <a class="text-decoration-none register d-flex align-items-center justify-content-center fw-bold fs-6" href='/register'>{{__('ui.register')}}</a>
                    </li>
                    @endguest
