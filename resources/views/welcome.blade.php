    ...
    <div class="row row-cols-xl-5 justify-content-center align-items-center my-5">
        ...
        <div class="col">
            <ul class="d-flex justify-content-center flex-wrap list-unstyled m-0">
                <li class="m-3 flex-shrink-0 d-flex linav" style="background-image: url('/img/{{$category->foto}}');"><a
                        class="text-decoration-none text-white fs-3 fw-bold align-items-center d-flex justify-content-center"
    ...
    <div class="row mt-5 vw-100 justify-content-center align-items-top" id="5ultimos">
        ...
        <div class="col-12 col-md-6">
            <div class="card my-3 mycard" style="max-width:650px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img class="img-fluid h-100" src="{{$announcement->images->first()->getUrl(300,380)}}"
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body d-flex flex-column h-100">
                            <div>
                                ...
                                <div class="d-flex justify-content-between mt-5">
                                    <span
                                        class="text-danger border border-danger rounded-pill p-2">{{$announcement->price}}
                                        €</span>
